...
public class VideoController implements View.OnClickListener
{
    ...
    public VideoController(RelativeLayout toolbar, PlayerControl player, boolean changeOrientation)
    {
        ...
        imgFullscreen = (ImageView) toolbar.findViewById(R.id.video_tool_imgFullscreen); // 点击全屏
    ...
    public void settbtnGyroEnabled(boolean val)
    {
        if (player != null)
            player.setGyroEnabled(val);
        tbtnGyro.setChecked(val);
    }
